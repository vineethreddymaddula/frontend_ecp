    ...
    <div className="space-y-4">
      ...
      <div className="app-card">
        <button 
          ...
          className="w-full flex items-center justify-between p-3 bg-primary-50 dark:bg-primary-700 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-600 transition-colors"
        >
          <div className="flex items-center gap-3">
            <MdSettings className="w-5 h-5 text-primary-600 dark:text-primary-400" />
            <span className="text-app-base font-semibold text-primary-900 dark:text-primary-100">Settings</span>
          </div>
        ...
        {isSettingsOpen && (
          <div className="mt-3 space-y-2 animate-fade-in">
            <button 
              ...
              className="w-full flex items-center gap-3 p-3 bg-primary-50 dark:bg-primary-700 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-600 transition-colors text-left"
            >
              <MdLock className="w-5 h-5 text-orange-500" />
              <span className="text-app-sm text-primary-900 dark:text-primary-100">Change Password</span>
            </button>
            <button 
            ...
            >
              ...
              <span className="text-app-sm text-primary-900 dark:text-primary-100">Manage Addresses</span>
            </button>
            <button 
              onClick={() => showToastMessage('Payment methods feature coming soon!')}
              className="w-full flex items-center gap-3 p-3 bg-primary-50 dark:bg-primary-700 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-600 transition-colors text-left"
            >
              <MdPayment className="w-5 h-5 text-green-500" />
              <span className="text-app-sm text-primary-900 dark:text-primary-100">Payment Methods</span>
            </button>
            <button 
              onClick={() => setActiveModal('notifications')}
              className="w-full flex items-center gap-3 p-3 bg-primary-50 dark:bg-primary-700 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-600 transition-colors text-left"
            >
              <MdNotifications className="w-5 h-5 text-purple-500" />
              <span className="text-app-sm text-primary-900 dark:text-primary-100">Notifications</span>
            </button>
          </div>
        )}
      </div>
